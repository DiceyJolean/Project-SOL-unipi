...
./client -f filesocket -w ./test/Inferno1-10/ -D ./esplusi/ -R n=1 -d ./letti/ -W ./test/sample.txt -l ./test/sample.txt -u ./test/sample.txt -c ./test/sample.txt &
./client -f filesocket -W ./test/long1.txt,./test/long2.txt,./test/long3.txt -D ./esplusi/ -r ./test/sample.txt -d ./letti/ -W ./test/sample2.txt -l ./test/sample2.txt -u ./test/sample2.txt -c ./test/sample2.txt &
...
./client -f filesocket -c ./test/long1.txt,./test/long2.txt,./test/long3.txt,./test/long4.txt -c ./test/Inferno11-20/Canto11.txt,./test/Inferno11-20/Canto12.txt,./test/Inferno11-20/Canto13.txt,./test/Inferno11-20/Canto14.txt,./test/Inferno11-20/Canto15.txt &
